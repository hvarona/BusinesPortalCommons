...
public class StoreClosureData extends AbstractBusinessPortalWs  {

    private static final Logger logger = Logger.getLogger(StoreClosureData.class);
    ...
    private Date getDate(String strDate) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StoreClosureData.class.getName()).log(Level.SEVERE, null, ex);
